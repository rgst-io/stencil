...
type Template struct {
	...
	// extraFiles are files that were generated by stencil functions but
	// NOT user facing (e.g., MigrateFrom). These are added onto the end
	// of [Files]. This enables us to determine if a template caller
	// called file.Create when determining to use tpls render contents or
	// not.
	extraFiles []*File
...
func (t *Template) Render(st *Stencil, vals *Values) error {
	...
	// If there's extra file, append those to the end.
