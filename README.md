...
If you have `mise` installed, you should have all the tooling you need for the docs engine.  Just run `bun run docs:dev` from the `docs` directory to enter the watch-rebuild cycle to test your docs changes.
