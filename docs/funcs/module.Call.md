...
`.` in a template function acts the same way as it does for [stencil.Include](<stencil.Include.html>) (`stencil.Include`). Meaning, it points to [Values](<../reference/values.html>). The caller passed data is accessible on `.Data`.
